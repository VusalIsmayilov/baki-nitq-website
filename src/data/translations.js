export const translations = {
  az: {
    ...
    testimonials: 'Rəylər',
    gallery: 'Resurslar və Tədbirlər',
    contact: 'Əlaqə',
    ...
    // Gallery
    galleryTitle: 'Öyrən və İştirak Et',
    galleryDesc: 'Ünsiyyət bacarıqlarınızı inkişaf etdirmək üçün praktiki seminarlar, canlı vebinarlar və dərin resurslar tapın.',
    gallerySubtitle: 'Öyrən və İştirak Et',
    eventsTab: 'Tədbirlər',
    blogTab: 'Blog',
    downloadsTab: 'Yüklənmələr',
    articlesResourcesTab: 'Məqalələr və Resurslar',
    upcomingEvents: 'Gələcək Tədbirlər',
    eventsComingSoon: 'Tezliklə Tədbirlər',
    eventsComingSoonDesc: 'Yaxın zamanda keçiriləcək seminar və vebinarlar haqqında məlumat burada yerləşəcək.',
    // Event Catalogue
    dateRange: 'Tarix aralığı',
    format: 'Format',
    allFormats: 'Bütün formatlar',
    offline: 'Oflayn',
    online: 'Onlayn',
    ...
    spotsLeft: 'qalan yer',
    register: 'Qeydiyyat',
    filterEvents: 'Tədbirləri filtrləyin',
    // Article Library
    searchArticles: 'Məqalə axtarın...',
    allTags: 'Bütün etiketlər',
    bodyLanguage: 'Bədən dili',
    tips: 'Məsləhətlər',
    ...
    loadMoreEvents: 'Daha çox tədbir yüklə',
    loadMoreArticles: 'Daha çox məqalə yüklə',
    remaining: 'qalan',
    // Conversion CTA
    needHelpChoosing: 'Özünüzə uyğun proqram seçməkdə kömək lazımdır?',
    teamReady: 'Komandamız hazırdır.',
    ...
    // Contact
    contactTitle: 'Əlaqə',
    contactHeroLead: 'Bizimlə əlaqə saxlayın – həftə içi 09:00-18:00 arasında cavab veririk.',
    contactInfo: 'Əlaqə Məlumatları',
    viewOnYandexMaps: 'Yandex Maps-də bax',
    ...
    messageSuccessToast: 'Mesajınız göndərildi, təşəkkür edirik!',
    required: 'tələb olunur',
    followUs: 'Bizi İzləyin',
    socialMedia: 'Sosial Media',
    instagram: 'Instagram',
    facebook: 'Facebook',
    centerDescription: 'Bakı şəhərində peşəkar nitq təlimi mərkəzi',
  ...
  en: {
    ...
    // Gallery
    galleryTitle: 'Learn & Participate',
    galleryDesc: 'Find practical seminars, live webinars and in-depth resources to elevate your communication skills.',
    gallerySubtitle: 'Learn & Participate',
    eventsTab: 'Events',
    blogTab: 'Blog',
    downloadsTab: 'Downloads',
    articlesResourcesTab: 'Articles & Resources',
    upcomingEvents: 'Upcoming Events',
    eventsComingSoon: 'Events Coming Soon',
    eventsComingSoonDesc: 'Information about upcoming seminars and webinars will be posted here soon.',
    // Event Catalogue
    ...
    remaining: 'remaining',
    // Conversion CTA
    needHelpChoosing: 'Need help choosing the right programme?',
    teamReady: 'Our team is ready.',
    ...
    contactHeroLead: 'Contact us – we respond weekdays 09:00-18:00.',
    contactInfo: 'Contact Information',
    viewOnYandexMaps: 'View on Yandex Maps',
    ...
    messageSuccessToast: 'Your message has been sent, thank you!',
    required: 'required',
    followUs: 'Follow Us',
    socialMedia: 'Social Media',
    instagram: 'Instagram',
    facebook: 'Facebook',
    centerDescription: 'Professional speech training center in Baku, Azerbaijan',
    allRightsReserved: 'All rights reserved',
    addressText: 'Aynali Plaza, Ahmad Rajabli 156, Narimanov district, Baku city',
    phoneText: '+994102271404',
    emailText: 'info@bakinitqmerkezi.az',
  ...
  ru: {
    ...
    // Gallery
    galleryTitle: 'Учитесь и Участвуйте',
    galleryDesc: 'Найдите практические семинары, живые вебинары и углубленные ресурсы для развития ваших коммуникативных навыков.',
    gallerySubtitle: 'Учитесь и Участвуйте',
    eventsTab: 'Мероприятия',
    blogTab: 'Блог',
    downloadsTab: 'Загрузки',
    articlesResourcesTab: 'Статьи и Ресурсы',
    upcomingEvents: 'Предстоящие Мероприятия',
    eventsComingSoon: 'Мероприятия Скоро',
    eventsComingSoonDesc: 'Информация о предстоящих семинарах и вебинарах будет опубликована здесь в ближайшее время.',
    // Event Catalogue
    ...
    remaining: 'осталось',
    // Conversion CTA
    needHelpChoosing: 'Нужна помощь в выборе подходящей программы?',
    teamReady: 'Наша команда готова.',
    ...
    contactHeroLead: 'Свяжитесь с нами – отвечаем в будни 09:00-18:00.',
    contactInfo: 'Контактная информация',
    viewOnYandexMaps: 'Посмотреть на Яндекс Картах',
    ...
    messageSuccessToast: 'Ваше сообщение отправлено, спасибо!',
    required: 'обязательно',
    followUs: 'Подписывайтесь на нас',
    socialMedia: 'Социальные сети',
    instagram: 'Instagram',
    facebook: 'Facebook',
    centerDescription: 'Профессиональный центр обучения речи в Баку, Азербайджан',
    allRightsReserved: 'Все права защищены',
    addressText: 'Айналы Плаза, Ахмед Раджабли 156, Нариманов район, город Баку',
    phoneText: '+994102271404',
    emailText: 'info@bakinitqmerkezi.az',
